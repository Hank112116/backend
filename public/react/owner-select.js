...
var OwnerInput = React.createClass({ displayName: 'OwnerInput',
	...
	switchOwner: function switchOwner() {
...
var OwnerSelector = React.createClass({ displayName: 'OwnerSelector',
	...
	switchOwner: function switchOwner(user) {
		this.setState({ user: user });
	},

	render: function render() {
		return React.DOM.div(null, OwnerInput({ user_id: this.state.user.user_id, switchOwner: this.switchOwner }), OwnerWrapper({ user: this.state.user }));
	}
});

module.exports = OwnerSelector;

},{"./OwnerInput.react":3,"./OwnerWrapper.react":5,"react":161}],5:[function(require,module,exports){
/**
  * @jsx React.DOM
  */
